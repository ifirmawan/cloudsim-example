...
public class Host {
	...
	private double zeroutiliationwatt=86;//anupinder
	private double fulluniliationwatt = 177;//anupinder
	private static double powerconsumedinwatts;//anupinder
	...
	public double updateVmsProcessing(double currentTime) {
		...
		double timeofStartprocessing = CloudSim.clock();//anupinder
		Log.printLine("Start of Vm Processing " + CloudSim.clock());//anupinder
		...
		double timeofStopprocessing = CloudSim.clock();//anupinder

		Log.printLine("Stop of Vm Processing " + CloudSim.clock());//anupinder
		double totalfullutilizationwattsConsumed = (timeofStopprocessing) * fulluniliationwatt;//anupinder
		powerconsumedinwatts += totalfullutilizationwattsConsumed;//anupinder
		return smallerTime;
	}
	...
	//anupinder
	public double getpowerconsumedinwatts()
	{
		return powerconsumedinwatts;
	}
